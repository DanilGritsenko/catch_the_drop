...
import static com.company.Paint.*;
...
public class GameWindow extends JFrame {
    ...
    public static void main(String[] args) throws IOException {
        db = new Database("jdbc:mysql://localhost/waterdrop?useLegacyDatetimeCode=false&serverTimezone=Europe/Helsinki", "root", ""); // База данных в XAMPP
        db.init();
            ...
            public void mousePressed(MouseEvent e) {
                ...
                if(is_drop){
                    if(!(kap_height<=25 && kap_width<=50)){
                        ...
                        try{
                            kapResize(); // Функция в Paint.java
                        }
    ...
    private static class GameField extends JPanel{
        ...
        protected void paintComponent(Graphics g){
            ...
            onRepaint(g); // Функция в Paint.java
            repaint();
        }
    }
}